...
- [Parts Selection & Reasoning](#drive-system)
...
- [Programming Logic](#programming-logic)
  ...
  - [Obstacle Challenge Code](#obstacle-challenge-code)
    - [1. Detect an obstacle](#1-detect-an-obstacle)
    - [2. Select the obstacle to react to](#2-select-the-obstacle-to-react-to)
    - [3. Find the gap to steer through](#3-find-the-gap-to-steer-through)
    - [4. Steer toward the gap](#4-steer-toward-the-gap)
    - [5. Safety check — too close to the wall](#5-safety-check--too-close-to-the-wall)
    - [6. Check if the obstacle is cleared](#6-check-if-the-obstacle-is-cleared)
    - [Parking States](#parking-states)
