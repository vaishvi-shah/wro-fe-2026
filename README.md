...
<table align="center">
  ...
  <tr>
    <td align="center">Vaishvi Shah</td>
    <td align="center">Software &amp; Logic</td>
  </tr>
  <tr>
    <td align="center">Avani Devalankar</td>
    <td align="center">3D Design &amp; Hardware</td>
  </tr>
  <tr>
    <td align="center">Jaitra Bhatt</td>
...
- [Overview](#overview)
  ...
  - [Obstacle Video](#obstacle-video)
  - [Meet The Robot](#meet-the-robot)
    - [Preliminary Work](#preliminary-work)
- [Introduction](#introduction)
- [Mobility & Mechanical Design](#mobility--mechanical-design)
  - [First Iteration - LEGO Chassis](#first-iteration--lego-chassis)
  - [Second Iteration - 3D-Printed Chassis](#second-iteration--3d-printed-chassis)
    - [Chassis Design](#chassis-design)
    - [Issues Identified](#issues-identified)
  - [Third Iteration - Physical Fit](#third-iteration--physical-fit)
    - [Chassis & Motor Fit](#chassis--motor-fit)
    - [Chassis & Weight Distribution](#chassis--weight-distribution)
    - [Mounting & Fastening](#mounting--fastening)
    - [Accessibility & Wiring](#accessibility--wiring)
    - [Battery Placement](#battery-placement)
    - [Rear Wheel Bearings](#rear-wheel-bearings)
    - [Screw Usage](#screw-usage)
- [Parts Selection & Reasoning](#parts-selection--reasoning)
  - [Drive System](#drive-system)
    - [Motor Selection](#motor-selection)
      - [Motor 1: JGA25-371 620 RPM DC Motor](#motor-1-jga25-371-620-rpm-dc-motor)
        - [Motor 1 Specifications](#motor-1-specifications)
      - [Motor 2: Lower-RPM JGA25-371 Variant](#motor-2-lower-rpm-jga25-371-variant)
    - [Motor Torque and Acceleration Calculations](#motor-torque-and-acceleration-calculations)
      - [Parameters](#parameters)
      - [Summary](#summary)
      - [Motor Final Decision](#motor-final-decision)
    - [Steering, Servo & Differential Design](#steering-servo--differential-design)
      - [WLToys 144001](#wltoys-144001)
      - [Ackermann Steering](#ackermann-steering)
      - [Servo: MG90S Servo](#servo-mg90s-servo)
        - [Servo Specifications](#servo-specifications)
  - [Power & Sensor Architecture](#power--sensor-architecture)
    - [Component Placement](#component-placement)
    - [Microcontroller Selection & Development](#microcontroller-selection--development)
      - [Iteration 1: micro:bit](#iteration-1-microbit)
      - [Raspberry Pi Pico 2 W](#raspberry-pi-pico-2-w)
    - [Raspberry Pi 5](#raspberry-pi-5)
      - [MPU6050](#mpu6050)
      - [BNO055](#bno055)
      - [IMU Comparison Table](#imu-comparison-table)
      - [IMU Final Decision](#imu-final-decision)
  - [Motor Driver Iterations](#motor-driver-iterations)
    - [Iteration 1 — DRV8871](#iteration-1--drv8871)
    - [Iteration 2 — L298N](#iteration-2--l298n)
    - [Motor Driver Comparison Table](#motor-driver-comparison-table)
    - [Motor Driver Final Decision](#motor-driver-final-decision)
  - [Camera: OV5647 Wide-Angle Camera](#camera-ov5647-wide-angle-camera)
  - [Parking: TOF Sensor vs. Motor Encoder](#parking-tof-sensor-vs-motor-encoder)
    - [Parking Sensor Comparison Table](#parking-sensor-comparison-table)
    - [Parking Sensor Final Decision](#parking-sensor-final-decision)
...
- [Power System Architecture](#power-system-architecture)
  - [Two Board Architecture](#two-board-architecture)
    - [Why Two Boards?](#why-two-boards)
    - [Power Distribution](#power-distribution)
  - [Power Distribution Diagram: Nominal Values](#power-distribution-diagram-nominal-values)
  - [Nominal Current Draw for Each Part](#nominal-current-draw-for-each-part)
  - [Power Budget](#power-budget)
    - [5 V Power Requirement](#5-v-power-requirement)
    - [Motor Power](#motor-power)
    - [Total System Requirement](#total-system-requirement)
  - [Why This Matters](#why-this-matters)
- [Programming Logic](#programming-logic)
  - [Open Challenge Logic](#open-challenge-logic)
    - [1. Get Sensor Inputs](#1-get-sensor-inputs)
    - [2. Calculate Steering](#2-calculate-steering)
    - [3. Clamp Steering](#3-clamp-steering)
    - [4. Check for Bottom Lines](#4-check-for-bottom-lines)
  - [Obstacle Challenge Code](#obstacle-challenge-code)
    - [Iteration 1 — Initial Obstacle Avoidance](#iteration-1--initial-obstacle-avoidance)
      - [Iteration 1 Step 1: Detect an Obstacle](#iteration-1-step-1-detect-an-obstacle)
      - [Iteration 1 Step 2: Select the Obstacle to React To](#iteration-1-step-2-select-the-obstacle-to-react-to)
      - [Iteration 1 Step 3: Determine the Passing Side](#iteration-1-step-3-determine-the-passing-side)
      - [Iteration 1 Step 4: Find the Gap to Steer Through](#iteration-1-step-4-find-the-gap-to-steer-through)
      - [Iteration 1 Step 5: Steer Toward the Gap](#iteration-1-step-5-steer-toward-the-gap)
      - [Iteration 1 Step 6: Safety Check](#iteration-1-step-6-safety-check)
      - [Iteration 1 Step 7: Check if the Obstacle Was Cleared](#iteration-1-step-7-check-if-the-obstacle-was-cleared)
    - [Iteration 2 — Improved Obstacle Avoidance](#iteration-2--improved-obstacle-avoidance)
      - [Iteration 2 Step 1: Detect an Obstacle](#iteration-2-step-1-detect-an-obstacle)
      - [Iteration 2 Step 2: Select the Closest Obstacle](#iteration-2-step-2-select-the-closest-obstacle)
      - [Iteration 2 Step 3: Determine the Passing Side](#iteration-2-step-3-determine-the-passing-side)
      - [Iteration 2 Step 4: Improve the Gap Calculation](#iteration-2-step-4-improve-the-gap-calculation)
      - [Iteration 2 Step 5: Steer Toward the Gap](#iteration-2-step-5-steer-toward-the-gap)
      - [Iteration 2 Step 6: Safety Check — Obstacle Too Close](#iteration-2-step-6-safety-check--obstacle-too-close)
      - [Iteration 2 Step 7: Check if the Obstacle Is Cleared](#iteration-2-step-7-check-if-the-obstacle-is-cleared)
    - [Iteration Comparison](#iteration-comparison)
    - [Parking](#parking)
      - [`OUT_PARKING`](#out_parking)
  ...
  - [Step-by-Step Assembly Guide](#step-by-step-assembly-guide)
    - [1. Print the Chassis](#1-print-the-chassis)
    - [2. Assemble the Drivetrain](#2-assemble-the-drivetrain)
    - [3. Assemble the Steering](#3-assemble-the-steering)
    - [4. Mount Layer 1 Components](#4-mount-layer-1-components)
      - [Camera Position](#camera-position)
    - [5. Mount Layer 2 Components](#5-mount-layer-2-components)
    - [6. Wire the Power System](#6-wire-the-power-system)
      - [Wiring Recommendations](#wiring-recommendations)
    - [7. Wire Control Signals](#7-wire-control-signals)
    - [8. Attach the Front Bumper](#8-attach-the-front-bumper)
    - [9. Calibrate Before Every Run](#9-calibrate-before-every-run)
    - [10. Bench Test Before Full Track Runs](#10-bench-test-before-full-track-runs)
## Meet The Robot
...
Images of how every part connects for each iteration is available under the photos folder. Ensure you look under Batmobile Iteration 3 not the older iterations.
